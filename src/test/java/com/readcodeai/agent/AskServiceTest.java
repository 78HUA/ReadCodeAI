 ...
 *
 * <p>没配 Key 时自动跳过；运行前先 {@code source notes/llm-env.sh}。
 */
@SpringBootTest
class AskServiceTest {
    ...
    void answersWithEvidenceAndOnlyCitesChunksItWasGiven() {
        ...
        AskAnswer answer = answerService.ask(null, "登录检查是在哪里做的？", null, 8);
    ...
    void scopingToOneFileNarrowsTheSearch() {
        ...
        AskAnswer answer = answerService.ask(null, "这个过滤器做了什么？",
